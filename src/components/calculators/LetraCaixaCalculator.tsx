...
const LetraCaixaCalculator: React.FC = () => {
  ...
  const handleCopy = () => {
    ...
    const texto = `Letra Caixa — ${MATERIAL_LABEL[material]}${ilumSuffix}
${detalhe}
