...
// que aplicam piso ao total (Adesivo, Placa ACM, Letra PVC).
// Obs.: Vidro, Fachada, Luminoso, Laser e Placa PS são precificados pelo motor da
// skill (Edge Functions) e não têm configuração editável aqui.
